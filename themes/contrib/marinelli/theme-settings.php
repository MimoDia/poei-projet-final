...
// 	$i = 0;
	...
	// 			'#type' => 'details',
	// 			'#title' => t('Image !number: !title', ['!number' => $i + 1, '!title' => $image_data['image_title']]),
	// 			'#weight' => $i,
	// 			'#tree' => TRUE,
...
/**
 * Save file Uploaded by  user and genrate setting to save
 *
 * @param file $file
...
/**
 * Provides default installation settings for marinelli
 */
...
// 	$config = \Drupal::service('config.factory')->getEditable('marinelli.settings');
// 	$config->set('theme_marinelli_first_install', FALSE)
// 		->save();
// }
...
// 	// Image preview.
// 	$img_form['image_preview'] = [
// 		'#markup' => theme('image', ['path' => $image_data['image_thumb']]),
// 	];
...
// 	// Thumbnail path.
// 	$img_form['image_thumb'] = [
// 		'#type' => 'hidden',
// 		'#value' => $image_data['image_thumb'],
// 	];

// 	// Image title.
// 	$img_form['image_title'] = [
// 		'#type' => 'textfield',
// 		'#title' => t('Title'),
